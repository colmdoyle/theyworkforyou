...
<div style="position: relative; width: 17em; color: #000000; background-color: #E8FDCB; font-family: Arial, Geneva, Sans-serif; margin-bottom: 1em; border: 1px solid #4d6c25; padding: 0 10px 2em 10px;">
    ...
    <form style="margin: 0; padding: 5px 0 0 0;" title="Find out about your MP" action="https://www.theyworkforyou.com/mp/" method="get">
    ...
    <form style="margin: 0; padding: 5px 0 0 0;" title="Search everything said in Parliament since 2001" action="https://www.theyworkforyou.com/search/" method="get">
        <label style="display: block; font-size: small; font-weight: bold; margin: 0 0 2px 0;" for="search_input">Search Parliament</label>
        <input id="search_input" name="q" style="width: 12em; border: solid 1px #4D6C25;" title="Type what you're looking for" type="text" tabindex="3" size="15" maxlength="100" value="Your Search">
...
?>
            ...
            <p>Please retain the link to <a href="https://www.theyworkforyou.com">theyworkforyou.com</a> (Google points mean prizes). Any questions, just drop us a line at: <a href="https://www.theyworkforyou.com/contact/">https://www.theyworkforyou.com/contact/</a>
        </div>
    </div>
</div>
